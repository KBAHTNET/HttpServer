...
namespace HttpServer.CipherSystem
{
    ...
    public static class Kuznechik
    {
        ...
        private static void KuzF(byte[] input1, byte[] input2, ref byte[] output1, ref byte[] output2, byte[] round_C)
        {
        ...
        private static void KuzKeyGen(byte[] mas_key)
        {
        ...
        public static byte[] KuzEncript(byte[] file, byte[] masterKey)
        {
        ...
        public static byte[] KuzDecript(byte[] file, byte[] masterKey)
        {
            masterKey = Encoding.Default.GetBytes(LengthTo32Bytes(Encoding.Default.GetString(masterKey)));
            KuzKeyGen(masterKey);
        ...
        private static string LengthTo32Bytes(string str)
        {
            if (str.Length < 32)
            {
